...
var SenseSearchInput = function() {
        ...
        nlpViz: {
            value: function() {
                ...
                for (var t = 0; t < this.nlpTerms.length; t++) {
                    ...
                    if (this.nlpTerms[t].senseInfo && this.nlpTerms[t].senseInfo.field && this.nlpTerms[t].senseInfo.field.qInfo && this.nlpTerms[t].senseInfo.field.qInfo.qId) {} else {
    ...
    function getGhostString(query, suggestion) {
        ...
        if (suggestion.toLowerCase().indexOf(suggestBase.toLowerCase()) != -1) {} else if (suggestion.length > suggestBase.length) {
